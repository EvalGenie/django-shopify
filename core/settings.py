...
SECRET_KEY = env('SECRET_KEY', default='7X7VklSGyHD3VnEbujkcusea2zZQRTkpJUP0gsYntizboNiAE6hcZ9PG2jPRgPZ')
...
ALLOWED_HOSTS = ['*', 'evalgenie.eba-ahpn9zvp.us-east-1.elasticbeanstalk.com', 'localhost', '127.0.0.1']
CSRF_TRUSTED_ORIGINS = ['*', 'evalgenie.eba-ahpn9zvp.us-east-1.elasticbeanstalk.com', 'localhost', '127.0.0.1']
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'authentication.validators.MixedCaseAndSpecialCharactersValidator',
    },
    # Add other custom validators if needed
]
...
# PAYPAL_RECEIVER_EMAIL = 'sb-cynf525320357@business.example.com'
